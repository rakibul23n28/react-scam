  ...
  return (
    <footer className="bg-gray-800 text-white py-8 px-2">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className="text-gray-400">
            Your trusted platform for financial growth. Start your journey to
        ...
        <div>
          ...
          <p>
            Email:{" "}
            <a
              href="mailto:support@zeedben77pro.com"
              className="hover:text-gray-400"
            >
              support@zeedben77pro.com
            </a>
          </p>
          <p>
            Phone:{" "}
      ...
      <div className="border-t border-gray-700 mt-8 pt-6 text-center">
        <p className="text-gray-400">
          &copy; {new Date().getFullYear()} ZeedBen77
          <span className="text-red-600">Pro</span>. All rights reserved.
        </p>
      </div>
    </footer>
  );
