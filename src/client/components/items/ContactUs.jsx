    ...
    <div>
      ...
      >
        <div className="container mx-auto">
          {/* // got a question */}
          <h2 className="text-3xl font-bold text-center mb-6 text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
            Contact Us
          </h2>
              ...
              <div className="flex items-center">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M12 11c2.21 0 4-1.79 4-4S14.21 3 12 3 8 4.79 8 7s1.79 4 4 4zM12 14c-5.33 0-8 2.69-8 4v1h16v-1c0-1.31-2.67-4-8-4z"
                  />
                </svg>
