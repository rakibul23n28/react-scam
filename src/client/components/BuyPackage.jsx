...
const BuyPackage = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <h2 className="text-3xl font-bold text-center mb-4">{selectedPackage.name}</h2>
      <p className="text-lg text-gray-700 text-center mb-4">{selectedPackage.description}</p>
