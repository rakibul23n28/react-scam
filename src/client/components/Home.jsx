          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="text-gray-700 text-lg leading-8">
                To offer cutting-edge financial solutions that allow our users
                to maximize their earning potential while fostering trust and
                transparency.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="text-gray-700 text-lg leading-8">
                To be the most trusted and reliable platform for financial
                growth and success, where users can achieve their financial
                goals with ease.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-2xl font-bold mb-4">
                Why ZeedBen77Pro is Helpful
              </h3>
              <p className="text-gray-700 text-lg leading-8">
                Our platform empowers individuals to grow their wealth through
                innovative packages, offering financial solutions tailored for
